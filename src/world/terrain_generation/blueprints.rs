...
// Many features share the same layout, so even though blueprints are mainly meant to compose
// features, some simple blueprints for common features are made available. If you want to
// create a new type of feature, it is intended to be programmed as a 'Generator'.
#[derive(Clone)]
pub enum Blueprint {
